    ...
    <div>
        ...
        <div className={style.content}>
          <p className={style.aboutIntro}>
              ...
              <br/><br/>
              As a Full Stack-Developer I would say I enjoy both the front- and backend. I see it all as one which I believe has been beneficial for me since I haven't been limited to just one of the stacks. 
                        </p>
