...
const projects = [
    ...
    },
    {
        ...
        description: "This was my thesis project at University. It's a start of a booking schedule were customers to businesses can book a time for the their services. Users were given the opportunity to switch between light- and darkmode. The main purpose of this project was to migrate from CSS to Sass and study the process in my thesis",
        tags: "React CSS Sass",
